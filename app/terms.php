...
<form id="form" action = "terms.php" method="post" enctype="multipart/form-data">
...
if(isset($_POST['aid'])){
	...
	$query = "UPDATE `legal` SET `terms` = '$article' WHERE `id` = $aid";
	
	$conn->query($query);
	 //echo $query;
	
	
    echo '<script>location.assign("terms.php");</script>';
...
<script src="../js2/terms.js"></script>
<script>
