...
?>
<h1>Edit About Us</h1>
<form id="form" action = "about.php" method="post" enctype="multipart/form-data">
...
if(isset($_POST['aid'])){
	...
	$query = "UPDATE `legal` SET `about` = '$article' WHERE `id` = $aid";
	
	$conn->query($query);
	 //echo $query;
	
	
    echo '<script>location.assign("about.php");</script>';
...
<script src="../js2/about.js"></script>
<script>
